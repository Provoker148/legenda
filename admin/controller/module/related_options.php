...
class ControllerModuleRelatedOptions extends Controller {
  ...
  public function index()
  {
    ...
    $this->data['entry_stock_control_help'] 			= $this->language->get('entry_stock_control_help');
		$this->data['entry_show_stock']      					= $this->language->get('entry_show_stock');
    $this->data['entry_show_stock_help'] 					= $this->language->get('entry_show_stock_help');
    ...
    $this->data['entry_update_options_help']  		= $this->language->get('entry_update_options_help');
		...
		$this->data['entry_subtract_stock']       									= $this->language->get('entry_subtract_stock');
		$this->data['entry_subtract_stock_help']       							= $this->language->get('entry_subtract_stock_help');
		$this->data['text_subtract_stock_from_product']       			= $this->language->get('text_subtract_stock_from_product');
		$this->data['text_subtract_stock_from_product_first_time']	= $this->language->get('text_subtract_stock_from_product_first_time');
    ...
    $this->data['entry_spec_model_help'] 					= $this->language->get('entry_spec_model_help');
		$this->data['entry_spec_sku']    							= $this->language->get('entry_spec_sku');
    $this->data['entry_spec_sku_help'] 						= $this->language->get('entry_spec_sku_help');
		$this->data['entry_spec_upc']    							= $this->language->get('entry_spec_upc');
    $this->data['entry_spec_upc_help'] 						= $this->language->get('entry_spec_upc_help');
		$this->data['entry_spec_location']    				= $this->language->get('entry_spec_location');
    $this->data['entry_spec_location_help'] 			= $this->language->get('entry_spec_location_help');
    ...
    $this->data['entry_spec_price_discount_help'] = $this->language->get('entry_spec_price_discount_help');
		$this->data['entry_spec_price_special']				= $this->language->get('entry_spec_price_special');
    $this->data['entry_spec_price_special_help'] 	= $this->language->get('entry_spec_price_special_help');
		...
		$this->data['option_select_first_not']  			= $this->language->get('option_select_first_not');
		$this->data['option_select_first']  					= $this->language->get('option_select_first');
		$this->data['option_select_first_last']  			= $this->language->get('option_select_first_last');
		...
		$this->data['entry_ro_description']						= $this->language->get('entry_ro_description');
		$this->data['ro_description_not']							= $this->language->get('ro_description_not');
		$this->data['ro_description_yes']							= $this->language->get('ro_description_yes');
		$this->data['ro_description_replace']					= $this->language->get('ro_description_replace');
		$this->data['ro_description_add']							= $this->language->get('ro_description_add');
		$this->data['entry_ro_description_help']			= $this->language->get('entry_ro_description_help');
				...
				if (!isset($json['error'])) {
					...
					for ($i=1;$i<count($data);$i++) {
						...
						$products[$product_id]['relatedoptions'][] = array(	'options'=>$options
																															...
																															, 'model'=> isset($head['relatedoptions_model']) ? $row[(float)$head['relatedoptions_model']] : ''
																															, 'sku'=> isset($head['relatedoptions_sku']) ? $row[(float)$head['relatedoptions_sku']] : ''
																															, 'upc'=> isset($head['relatedoptions_upc']) ? $row[(float)$head['relatedoptions_upc']] : ''
																															, 'location'=> isset($head['relatedoptions_location']) ? $row[(float)$head['relatedoptions_location']] : ''
																															, 'weight'=> isset($head['weight']) ? $row[(float)$head['weight']] : ''
																															, 'weight_prefix'=> isset($head['weight_prefix']) ? $row[(float)$head['weight_prefix']] : ''
																															);
