    ...
    <div class="right">
	  ...
	  <div class="cart">
        <div><?php echo $text_qty; ?>
          ...
          <span class="links"><a onclick="addToCompare('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a></span>
        </div>
        <?php if ($minimum > 1) { ?>
  ...
  <?php if ($options) { ?>
      <div class="options">
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <h3><span class="required">*</span>
          <?php } ?>
          <?php echo $option['name']; ?>:</h3><br />
...
<?php } ?>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          <?php if ($option['required']) { ?>
          <h3><span class="required">*</span><?php echo $option['name']; ?>:</h3>
          <?php } ?>
          <?php if (!($option['required'])) { ?>
          <h3><?php echo $option['name']; ?>:</h3>
          <?php } ?>
		  ...
		  <table class="option-image">
            ...
            <tr class="tr_my_options">
              <td style="width: 1px;"><label class="ps"><input type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" /><span class="psevdobox"></span></label></td>
